...
BENCHMARKS := baseline-opt/machsuite-aes \
	...
	rewrite-opt/machsuite-aes \
	rewrite-opt/machsuite-bfs-bulk \
	rewrite-opt/machsuite-bfs-queue \
	rewrite-opt/machsuite-fft-strided \
	rewrite-opt/machsuite-fft-transpose \
	rewrite-opt/machsuite-gemm-blocked \
	rewrite-opt/machsuite-gemm-ncubed \
	rewrite-opt/machsuite-kmp \
	rewrite-opt/machsuite-md-grid \
	rewrite-opt/machsuite-md-knn \
	rewrite-opt/machsuite-nw \
	rewrite-opt/machsuite-sort-merge \
	rewrite-opt/machsuite-sort-radix \
	rewrite-opt/machsuite-spmv-crs \
	rewrite-opt/machsuite-spmv-ellpack \
	rewrite-opt/machsuite-stencil-stencil2d \
	rewrite-opt/machsuite-stencil-stencil3d \
	rewrite-opt/machsuite-viterbi
	#baseline/machsuite-aes \
