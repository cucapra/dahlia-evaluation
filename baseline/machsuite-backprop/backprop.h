...
#pragma SDS data zero_copy(weights1[0:nput_dimension*nodes_per_layer], weights2[0:nodes_per_layer*nodes_per_layer], weights3[0:nodes_per_layer*possible_outputs], biases1[0:nodes_per_layer], biases2[0:nodes_per_layer], biases3[0:possible_outputs])
void backprop(
