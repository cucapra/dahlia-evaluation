...
int main(int argc, char **argv) {
  ...
  std::vector<TYPE, aligned_allocator<TYPE>> out(1);
  ...
  OCL_CHECK(err, err = krnl_gemm.setArg(3, out_buffer));
  OCL_CHECK(err, err = krnl_gemm.setArg(4, x));
